...
export default function DraggableCard({ todo, openModal, onDelete, isDeadlineLewat }) {
  ...
  return (
    <div ref={setNodeRef} {...listeners} {...attributes}
      ...
      <CardContent todo={todo} openModal={openModal} onDelete={onDelete} isDeadlineLewat={isDeadlineLewat} />
    </div>
  );
}